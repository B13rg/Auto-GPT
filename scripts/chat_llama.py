...
cfg = Config()
llm = Llama(model_path='/models/7b/model.bin')
...
def chat_with_llama(
    ...
    while True:
        try:
            ...
            send_token_limit = token_limit - 1000 #- tokenize_chat_ctx(current_context) - tokenize_chat_ctx(user_input)
            ...
            for message in list.reverse(full_message_history):
            ...
            current_context.append(new_messages)
            # Append user input, the length of this is accounted for above
            current_context.append(user_input)

            # Calculate remaining tokens
            tokens_remaining = token_limit - token_counter(current_context)
